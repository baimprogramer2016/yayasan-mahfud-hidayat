      ...
      <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
            ...
            @foreach ($provider_notif as $item_provider_notif)
            <a class="dropdown-item preview-item" href="{{ route('pendaftaran') }}">
              ...
              <div class="preview-item-content">
                <h6 class="preview-subject font-weight-normal">Pendaftaran Baru atas Nama {{ $item_provider_notif->nama_siswa }}</h6>
                <p class="font-weight-light small-text mb-0 text-muted">
                  {{ $item_provider_notif->created_at->diffForHumans() }}
                </p>
              </div>
            </a>
            @endforeach

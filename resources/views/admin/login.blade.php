            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST" action="{{ route('login-process') }}">
                ...
                <div class="form-group">
                  <input type="text" name="username" value="{{ old("username") }}" class="form-control form-control-lg  @error('username') is-invalid @enderror"" id="exampleInputEmail1" placeholder="Username">
                    @error("username")

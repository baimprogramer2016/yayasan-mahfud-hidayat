...
@section('title-page','Pendahuluan')
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Update Pendahuluan</h4>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href='{{ route('delete-pendahuluan', $data->id) }}' class="btn btn-sm btn-inverse-danger btn-fw">Hapus</a>
                    </td>
...
CKEDITOR.replace( 'deskripsi' );
    ...
    <script>
        ...
        {
            var url     = '{{ route("edit-pendahuluan", ":id") }}';

...
@section('title-page','Latar Belakang')
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Update Latar Belakang</h4>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                       ...
                       @else 
                        <img  data-toggle="modal" width="60" data-target="#exampleModal" onClick="viewImage('{{ $data->id }}')" src="{{ asset("uploads/$data->image") }}" style="cursor:pointer" alt="Ubah Gambar"> 
                    ...
                    <td>
                        ...
                        <a href='{{ route('delete-latar-belakang', $data->id) }}' class="btn btn-sm btn-inverse-danger btn-fw">Hapus</a>
                    </td>
...
CKEDITOR.replace( 'deskripsi' );
    ...
    <script>
        ...
        $.ajax({
            type: 'GET',
            url: "{{ route('tambah-latar-belakang') }}",
        ...
        {
            var url     = '{{ route("edit-latar-belakang", ":id") }}';
        ...
        {
            var url     = '{{ route("image-latar-belakang", ":id") }}';
            urlEdit     = url.replace(':id',paramId);
